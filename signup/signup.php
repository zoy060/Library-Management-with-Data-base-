...
<head>
    ...
    <style>
        * {
        ...
        .container {
            box-shadow: inset 0px 0px 100px 5px #000000;
            border-radius: 20px;
            /* margin: 10px; */
        }
...
<body>
    ...
    <div class="container ">
        <form class="m-auto row g-6 p-2 needs-validation" novalidate action="signup.control.php" method="post">
            ...
            <div class="col-md-4 p-2">
                ...
                <input name="fname" type="text" class="form-control" id="fname" placeholder="Fisrt name" required>
            ...
            <div class="col-12 p-2">
                ...
                <a class="signup btn btn-primary" href="../login/login.php">Log In</a>
            </div>
        </form>
    </div>
